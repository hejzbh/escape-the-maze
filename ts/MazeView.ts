...
export class MazeView implements MazeViewInterface {
  mazeElement: HTMLDivElement;
  containerElement: HTMLDivElement;

  constructor() {
    this.mazeElement = document.querySelector(".maze-grid") as HTMLDivElement;
  ...
  paintExitPath(steps: [number, number][]) {
